...
namespace lab1
{
    class BooleanExample
    {
        public static void Main(string[] args)
        {
            ...
            var a3 = 4.8;
            var result = a2 + a3;
            Console.WriteLine(result);// result - double
...
*/
            ...
            //Подчеркивание позволяет игнорировать значения, которые не требуются в данном контексте

            // распаковка через явное указание типов переменных
